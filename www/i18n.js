(function () {
  var T = {
    de: {
      ...
      'i.f1.title': 'Fortschritt sehen, nicht sch\u00e4tzen',
      'i.f1.desc': 'Sieh pro Fach und Thema genau, was du schon kannst und wo noch L\u00fccken sind \u2014 statt vor der Pr\u00fcfung im Dunkeln zu tappen.',
      'i.f2.title': '\u00dcberall dabei',
      'i.f2.desc': 'Laptop in der Bib, Handy unterwegs \u2014 dein Fortschritt ist automatisch synchronisiert und immer aktuell.',
      'i.f3.title': 'To-Do Liste',
      'i.f3.desc': 'Aufgaben mit Priorit\u00e4t, F\u00e4lligkeitsdatum und Fach-Zuordnung \u2014 alles an einem Ort statt \u00fcber drei Apps verteilt.',
      ...
      'i.f5.desc': 'Sieh auf einen Blick, wie viele Tage bis zur n\u00e4chsten Pr\u00fcfung noch bleiben \u2014 damit du nie unvorbereitet reingehst.',
      'i.f6.title': 'Dark Mode',
      'i.f6.desc': 'Schone deine Augen bei langen Lernabenden mit dem eleganten Dunkelmodus.',
      'i.f7.title': 'Vorlage laden, sofort starten',
      'i.f7.desc': 'Lade die F\u00e4cher-Struktur deiner Vorg\u00e4nger mit einem Klick \u2014 alle Themen, Kategorien und Pr\u00fcfungstermine sind sofort da. Kein m\u00fchsames Eintippen am Semesterstart.',
      ...
      'i.f10.title': 'Nie wieder raten, wo anfangen',
      'i.f10.desc': 'Studytracker zeigt dir automatisch das Thema mit den gr\u00f6ssten L\u00fccken. Du \u00f6ffnest die App und weisst sofort, was als n\u00e4chstes dran ist.',
      // INDEX – FAQ
      'i.faq.eyebrow': 'FAQ',
      ...
      'f.hero.subhead': 'Lade eine Vorlage, sieh wo du stehst, und die App sagt dir, was als n\u00e4chstes dran ist \u2014 kostenlos und ohne Installation.',
      ...
      'f.b1.p2': 'Vier Status-Stufen plus optionale Spaced Repetition (bis zu 3 Runden): <strong style="color:#555">Nicht begonnen</strong> \u2192 <strong style="color:#d4a843">In Arbeit</strong> \u2192 <strong style="color:#a78bfa">Wiederholen</strong> \u2192 <strong style="color:#00b87a">Fertig</strong> \u2192 <strong style="color:#2563eb">Repetitionen</strong>. Per Klick wechseln, kein Aufwand.',
      ...
      'f.b3.p1': 'Aufgaben mit Priorit\u00e4t, F\u00e4lligkeitsdatum und Fach-Zuordnung \u2014 alles an einem Ort statt \u00fcber drei Apps verteilt.',
      ...
      'f.b7.tag': 'Kern-Feature', 'f.b7.title': 'Vorlage laden, sofort starten',
      'f.b7.p1': 'Du musst nicht alles selbst eintippen. Lade die F\u00e4cher-Struktur deiner Vorg\u00e4nger mit einem Klick \u2014 alle Themen, Kategorien und Pr\u00fcfungstermine sind sofort da.',
      'f.b7.p2': 'Ideal f\u00fcr den Semesterstart: Eine Person legt die Struktur an, alle anderen profitieren. Du kannst auch eigene Vorlagen teilen oder aus Excel-Dateien und Bildern (per OCR) importieren.',
      // FEATURES PAGE – Setup
      ...
      'f.step2.desc': 'Lege deine Fächer an (z.B. VWL, Mathe, Recht) und füge pro Fach die Themen deines Semesters hinzu — oder importiere eine fertige Vorlage aus der Bibliothek. Du kannst jederzeit Themen hinzufügen oder umbenennen.',
      ...
      'a.hero.subhead': 'Studytracker entstand, weil wir im Assessmentjahr nicht wussten, wo wir stehen \u2014 und kein bestehendes Tool das Problem gel\u00f6st hat.',
      // ABOUT PAGE – Story
      'a.story.label': 'Die Geschichte', 'a.story.title': 'Warum Studytracker?',
      'a.story.p1': 'Vor der Pr\u00fcfung dieselbe Frage: Welche Themen kann ich schon, und wo sind noch L\u00fccken? Spreadsheets wurden un\u00fcbersichtlich. Notion war zu komplex. Und \u00abim Kopf behalten\u00bb funktioniert nicht, wenn man vier F\u00e4cher gleichzeitig lernt.',
      'a.story.p2': 'Also haben wir Studytracker gebaut: ein schlankes Tool, das dir pro Fach und Thema zeigt, wo du stehst. Lade die F\u00e4cher-Struktur deiner Vorg\u00e4nger als Vorlage \u2014 und die App sagt dir automatisch, welches Thema als n\u00e4chstes dran ist.',
    ...
    en: {
      ...
      'i.f1.title': 'See progress, don\'t guess', 'i.f1.desc': 'See exactly what you\'ve mastered and where gaps remain per subject and topic \u2014 instead of guessing before the exam.',
      'i.f2.title': 'Available everywhere', 'i.f2.desc': 'Laptop at the library, phone on the go \u2014 your progress is automatically synced and always up to date.',
      'i.f3.title': 'To-do list', 'i.f3.desc': 'Tasks with priority, due date and subject assignment \u2014 everything in one place instead of spread across three apps.',
      'i.f4.title': 'Daily goal', 'i.f4.desc': 'Set a daily study goal and track your progress with the Daily Dopamine Boost.',
      'i.f5.title': 'Exam countdown', 'i.f5.desc': 'See at a glance how many days remain until the next exam \u2014 so you never walk in unprepared.',
      'i.f6.title': 'Dark mode', 'i.f6.desc': 'Protect your eyes during long study sessions with the elegant dark mode.',
      'i.f7.title': 'Load a template, start instantly', 'i.f7.desc': 'Import a subject structure from previous students with one click \u2014 all topics, categories and exam dates ready to go. No tedious setup at the start of the semester.',
      ...
      'i.f10.title': 'Never guess where to start', 'i.f10.desc': 'Studytracker automatically shows you the topic with the biggest gaps. Open the app and know exactly what to study next.',
      // INDEX – FAQ
      'i.faq.eyebrow': 'FAQ',
      ...
      'f.hero.subhead': 'Load a template, see where you stand, and the app tells you what to study next \u2014 free and without installation.',
      ...
      'f.b1.p2': 'Four status levels plus optional spaced repetition (up to 3 rounds): <strong style="color:#555">Not started</strong> \u2192 <strong style="color:#d4a843">In progress</strong> \u2192 <strong style="color:#a78bfa">Review</strong> \u2192 <strong style="color:#00b87a">Done</strong> \u2192 <strong style="color:#2563eb">Repetitions</strong>. Switch with a click, no effort.',
      ...
      'f.b3.p1': 'Tasks with priority, due date and subject assignment \u2014 everything in one place instead of spread across three apps.',
      ...
      'f.b7.tag': 'Core feature', 'f.b7.title': 'Load a template, start instantly',
      'f.b7.p1': 'You don\'t have to type everything yourself. Import a subject structure from previous students with one click \u2014 all topics, categories and exam dates ready to go.',
      'f.b7.p2': 'Perfect for the start of the semester: one person creates the structure, everyone else benefits. You can also share your own templates or import from Excel files and images (via OCR).',
      // FEATURES PAGE – Setup
      ...
      'f.step2.title': 'Add subjects & topics', 'f.step2.desc': 'Create your subjects (e.g. Economics, Maths, Law) and add the topics for your semester — or import a ready-made template from the library. You can add or rename topics at any time.',
      ...
      'a.hero.subhead': 'Studytracker was born because we didn\'t know where we stood during our assessment year \u2014 and no existing tool solved that.',
      // ABOUT PAGE – Story
      'a.story.label': 'The story', 'a.story.title': 'Why Studytracker?',
      'a.story.p1': 'Before every exam the same question: Which topics do I know, and where are the gaps? Spreadsheets got messy. Notion was too complex. And \u201ckeeping track in your head\u201d doesn\'t work when you\'re studying four subjects at once.',
      'a.story.p2': 'So we built Studytracker: a lean tool that shows you where you stand per subject and topic. Load a subject structure from previous students as a template \u2014 and the app automatically tells you what to study next.',
      'a.story.p3': 'No subscription, no framework, no overhead. Just open it and go \u2014 on a laptop at the library or on your phone on the go.',
      // ABOUT PAGE – Values
